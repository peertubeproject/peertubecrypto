...
/** Utility functions used by the PeerTubeCrypto Qt UI.
 */
namespace GUIUtil
{
...
// Render PeerTubeCrypto addresses in monospace font
...
// Parse "peertube:" URI into recipient object, return true on successful parsing
