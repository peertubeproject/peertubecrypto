Contributing to PeerTubeCrypto Core
============================

The PeerTubeCrypto Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PeerTubeCrypto Core project, and is not to be
confused with overall PeerTubeCrypto Network Protocol consensus changes.

Whether a pull request is merged into PeerTubeCrypto Core rests with the project merge
...
Patches that change PeerTubeCrypto consensus rules are considerably more involved than
...
Where a patch set proposes to change the PeerTubeCrypto consensus, it must have been
...
The project leader is the release manager for each PeerTubeCrypto Core release.
