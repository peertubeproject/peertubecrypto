...
RESOURCES += src/qt/peertube.qrc src/qt/peertube_locale.qrc

TRANSLATIONS += src/qt/locale/peertube_bg.ts \
                src/qt/locale/peertube_de.ts \
                src/qt/locale/peertube_en.ts \
                src/qt/locale/peertube_es.ts \
                src/qt/locale/peertube_fi.ts \
                src/qt/locale/peertube_fr.ts \
                src/qt/locale/peertube_it.ts \
                src/qt/locale/peertube_ja.ts \
                src/qt/locale/peertube_pl.ts \
                src/qt/locale/peertube_pt.ts \
                src/qt/locale/peertube_ru.ts \
                src/qt/locale/peertube_sk.ts \
                src/qt/locale/peertube_sv.ts \
                src/qt/locale/peertube_vi.ts \
                src/qt/locale/peertube_zh_CN.ts \
                src/qt/locale/peertube_zh_TW.ts
