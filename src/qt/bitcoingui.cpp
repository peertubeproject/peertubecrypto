                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PeerTubeCrypto Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PeerTubeCrypto address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peertube: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPTCX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PeerTubeCrypto Core"), this);
    aboutAction->setStatusTip(tr("Show information about PeerTubeCrypto Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PeerTubeCrypto"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PeerTubeCrypto addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PeerTubeCrypto addresses"));
    ...
    openAction->setStatusTip(tr("Open a PeerTubeCrypto: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PeerTubeCrypto Core help message to get a list with possible PeerTubeCrypto command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PeerTubeCrypto Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PeerTubeCrypto network", "", count));
}
...
{
    QString strTitle = tr("PeerTubeCrypto Core"); // default title
    ...
    // Append title to "PeerTubeCrypto - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
