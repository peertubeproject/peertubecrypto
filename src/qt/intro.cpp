...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PeerTubeCrypto Core"),
     ...
     * override -datadir in the peertube.conf file in the default data directory
     * (to be consistent with peertubed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
