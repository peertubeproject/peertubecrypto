...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PeerTubeCrypto server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "PeerTubeCrypto server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PeerTubeCrypto features */
        {"peertube", "masternode", &masternode, true, true, false},
        {"peertube", "listmasternodes", &listmasternodes, true, true, false},
        {"peertube", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peertube", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peertube", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peertube", "masternodedebug", &masternodedebug, true, true, false},
        {"peertube", "startmasternode", &startmasternode, true, true, false},
        {"peertube", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peertube", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peertube", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peertube", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peertube", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peertube", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peertube", "mnbudget", &mnbudget, true, true, false},
        {"peertube", "preparebudget", &preparebudget, true, true, false},
        {"peertube", "submitbudget", &submitbudget, true, true, false},
        {"peertube", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peertube", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peertube", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peertube", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peertube", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peertube", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peertube", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peertube", "checkbudgets", &checkbudgets, true, true, false},
        {"peertube", "mnsync", &mnsync, true, true, false},
        {"peertube", "spork", &spork, true, true, false},
        {"peertube", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"peertube", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use peertubed, or the -server option to peertube-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> peertube-cli " + methodname + " " + args + "\n";
}
