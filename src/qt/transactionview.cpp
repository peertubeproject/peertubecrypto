                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Rup from zPtcx"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zPtcx"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zPtcx));
