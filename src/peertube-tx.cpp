...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PeerTubeCrypto Core peertube-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  peertube-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded peertube transaction") + "\n" +
                               "  peertube-tx [options] -create [commands]   " + _("Create hex-encoded peertube transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded peertube transaction
